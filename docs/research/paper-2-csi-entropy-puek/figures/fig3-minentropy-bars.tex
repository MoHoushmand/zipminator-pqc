...
\end{axis}
\end{tikzpicture}
\caption{NIST SP~800-90B final min-entropy assessment (\texttt{ea\_non\_iid}, byte-level, 99\% confidence). WiFi CSI achieves 5.50~bpb (69\% of theoretical maximum), compared to 6.35 for IBM Quantum (ibm\_kingston, 156~qubits) and 6.36 for \texttt{os.urandom}.}
